...
## [1.1.0](https://github.com/genirohtea/proxmox-host/compare/v1.0.0...v1.1.0) (2026-08-22)
...
* **disk health:** moved physical disk monitoring into dedicated role ([4e8fa08](https://github.com/genirohtea/proxmox-host/commit/4e8fa08d81ce7aabbc1929e1f2fb1e80c509cca5))
...
* **gmail notifications:** added role to setup gmail notifications for Proxmox ([71ce932](https://github.com/genirohtea/proxmox-host/commit/71ce932af47d0beebe0896e3410c15a28fe7ae6d))
* **google drive:** added google drive integration for etc backups ([4b77e15](https://github.com/genirohtea/proxmox-host/commit/4b77e1589ed43544dfc53c4462d15cd79aee0da9))
...
* **gpu passthrough:** added Intel Arc and shared VFIO binding ([4c4917f](https://github.com/genirohtea/proxmox-host/commit/4c4917f1297cfe31fb840aafdcd64b0bd31ee726))
* **host tuning:** added CPU scaling and hugepage roles ([44f4088](https://github.com/genirohtea/proxmox-host/commit/44f40888ed058e50fcc439c197f46c8e3acb43e3))
* **hugepages:** support removing a previously managed reservation ([94cec68](https://github.com/genirohtea/proxmox-host/commit/94cec68883eee5299b982d490b8bf2e8ddf61c28))
...
* **playbook:** integrated new Proxmox host roles ([f00220d](https://github.com/genirohtea/proxmox-host/commit/f00220d8b0b4eb9083910cc85b52429c2be79713))
* **pve storage:** added storage content management role ([8e880be](https://github.com/genirohtea/proxmox-host/commit/8e880bee0dabfa3e2b8a164ec53bad31174220b8))
* **telemetry:** push Proxmox metrics and logs ([c6cb447](https://github.com/genirohtea/proxmox-host/commit/c6cb4473e594444e072343a9c62b3b2370acc001))
...
* **vfio:** re-enumerate passthrough devices before guest start ([bf13c67](https://github.com/genirohtea/proxmox-host/commit/bf13c679f1c2a07c59bb0e196095fedcf25cb298))
...
* **ansible callbacks:** updated ansible.posix to 2.2.0 ([c10a0ab](https://github.com/genirohtea/proxmox-host/commit/c10a0ab25e0bc76e385b5bce999c177437031e5c))
...
* **ansible lint:** resolved pre-commit violations ([9e5cd9e](https://github.com/genirohtea/proxmox-host/commit/9e5cd9ebba1497245a1c17e426a9c374017ec0e3))
...
* **coral:** updated USB passthrough instructions ([37883cf](https://github.com/genirohtea/proxmox-host/commit/37883cfd0c2f728135040c944c4d9f49a1518f98))
...
* **driver script:** fixed overlapping flag for use_ssh ([ae4ca00](https://github.com/genirohtea/proxmox-host/commit/ae4ca00ec7b9df46fd302c384ac835aa80aabc63))
* **google drive:** fixed requirements for google drive role ([6e67b1a](https://github.com/genirohtea/proxmox-host/commit/6e67b1ae5da840a4f1aed110764b068eb3b8e294))
...
* **ipmi fan control:** retuned solid-state drive cooling ([a50723b](https://github.com/genirohtea/proxmox-host/commit/a50723b5e946cc148339570a29585011276cc313))
...
* **reboots:** increased host reboot timeout ([1359ff0](https://github.com/genirohtea/proxmox-host/commit/1359ff0d99859e4c96d1f646ba93a8b317871c8e))
